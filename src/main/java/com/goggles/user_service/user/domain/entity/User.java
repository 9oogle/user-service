...
public class User extends BaseTime {
  ...
  @Transient private final long MIN_AGE = 14;
  ...
  @Embedded private Consent consent;
  ...
  public void changeBasicInfo(
      String name, String nickName, LocalDate birthDate, RoleCheck roleCheck) {
    checkMine(roleCheck);
    ...
    if (this.name.equals(newName)
        && this.nickName.equals(newNickName)
        && this.birthDate.equals(birthDate)) {
      return;
    }
    this.name = newName;
