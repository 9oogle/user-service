...
public class Instructor extends BaseTime {
  ...
  @EmbeddedId private InstructorId id;
  ...
  @Embedded private InstructorDescription instructorDescription;

  @Column private LocalDateTime approvedAt;

  @Builder
  public Instructor(UUID userId, String field, String bio, String career, String portfolio) {
  ...
  public void registerBankAccount(
      Bank bankName, String accountNumber, String accountHolder, RoleCheck roleCheck) {
    checkMasterOnly(roleCheck);
    this.bankAccount = BankAccount.of(bankName, accountNumber, accountHolder);
  }

  public void changeInstructorDescription(
      String filed, String bio, String career, String portfolio, RoleCheck roleCheck) {
    checkMasterOnly(roleCheck);
